        ...
        <div class="col-md-1 tools-list">
            ...
            <div class="text-center my-1  option-menu-wrapper">
                <a href="#" class="btn btn-secondary btn-square mx-auto js-tools">
                    <img src="images/font-w.png" style="width:42px">
                </a>
            ...
            <div class="text-center my-1 option-menu-wrapper">
                ...
                <ul class="option-menu graph-menu" style="display: none;">
                    <li>
                        <a href="" class="js-tools" data-tool="xgraph">
                            <img src="images/graph-x.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="xygraph">
            ...
            <div class="text-center my-1 option-menu-wrapper">
                ...
                <ul class="option-menu shape-menu" style="display: none">
                    ...
                    <li>
                        <a href="" class="js-tools" data-tool="cube" data-cursor="corss-hair">
                            <img src="images/cube.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="oval" data-cursor="cross-hair">
                            <img src="images/circle.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="cylinder" data-cursor="cross-hair">
                            <img src="images/cylinder.png" alt="">
                        </a>
                    </li>
                    <li>
                        <a href="" class="js-tools" data-tool="cone" data-cursor="cross-hair">
                            <img src="images/cone.png" alt="">
                        </a>
                    </li>
                    
                    <li>
                        <a href="" class="js-tools" data-tool="pyramid" data-cursor="cross-hair">
